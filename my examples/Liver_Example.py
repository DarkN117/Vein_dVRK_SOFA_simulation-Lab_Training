...
def createScene(root):
    ...
    #LIVER VISUAL MODEL
    visual = liver.addChild('Visual Model')
    visual.addObject('OglModel', name="VisualModel", src="@../../LiverSurface")
    ...
    collision.addObject('SphereLoader', name="sphereLoader", filename="mesh/liver.sph")
    collision.addObject('MechanicalObject', name="spheres", position="@sphereLoader.position")
    collision.addObject('SphereCollisionModel', name="CollisionModel", listRadius="@sphereLoader.listRadius")
    collision.addObject('BarycentricMapping', name="CollisionMapping", input="@../dofs", output="@spheres")
