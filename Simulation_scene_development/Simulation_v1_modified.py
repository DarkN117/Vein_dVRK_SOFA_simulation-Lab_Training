...
def createScene(root):
    ...
    Vein.addObject('SparseLDLSolver', template="CompressedRowSparseMatrix", name="Torus1_SparseLDLSolver")
    ...
    Vein.addObject('UniformMass', name="mass", totalMass=[Vein_Mass])
    ...
    Vein.addObject('TetrahedronFEMForceField', youngModulus=500000, poissonRatio=0.4, method="large")
    ...
    Vein_visual.addObject('OglModel', name="VisualModel", material="Default Diffuse 1 1 0 0 1 Ambient 1 0.2 0 0 1 Specular 0 1 0 0 1 Emissive 0 1 0 0 1 Shininess 0 45", src="@loader",color=[0.8, 0.1, 0.3])
