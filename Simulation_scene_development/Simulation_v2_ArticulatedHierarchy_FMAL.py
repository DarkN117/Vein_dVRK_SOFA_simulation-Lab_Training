...
def main():
    ...
    print("\nFinal time at GUI closure:" + str(finalTime))
    print("\nGripper Jaws angle: " + str(root.Gripper.Articulations.position.value[0]) + " " + str(root.Gripper.Articulations.position.value[1]))
...
def createScene(root):
    ...
    root.addObject('LocalMinDistance', name="LMD-proximity" , alarmDistance=0.0001, contactDistance=0.00005, useLMDFilters=0)
