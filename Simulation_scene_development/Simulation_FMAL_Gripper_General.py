...
def createScene(root):
    ...
    box_left= root.addObject('BoxROI', template="Vec3d", name='box_roi_1', box=[-0.0585, 0.01, -0.002, -0.062, 0.030, 0.014], drawBoxes='False', drawSize="1")
    box_right = root.addObject('BoxROI', template="Vec3d", name='box_roi_2', box=[0.056, 0.01, -0.002, 0.059, 0.030, 0.014], drawBoxes='False', drawSize="1")
    ...
    R_Gripper.addObject('MechanicalObject', name="R_Gripper_Mech", template='Rigid3d', src="@meshLoader", position=[0, 0.025, 0.035, 1, 0, 0, 0], translation=[0, 0, 0], rotation=[0, 0, 0])
    #R_Gripper.addObject('TetrahedronSetGeometryAlgorithms', template="Rigid3d", name="GeomAlgo")
    R_Gripper.addObject('UniformMass', totalMass = "0")
    ...
    L_Gripper.addObject('MechanicalObject', name="L_Gripper_Mech", template='Rigid3d', src="@meshLoader", position=[0, 0.025, 0.035, 1, 0, 0, 0], translation=[0, 0, 0], rotation=[0, 0, 0])
    #L_Gripper.addObject('TetrahedronSetGeometryAlgorithms', template="Rigid3d", name="GeomAlgo")
    L_Gripper.addObject('UniformMass', totalMass = "0")
    L_Gripper.addObject('GenericConstraintCorrection', name="L_Gripper_ConstraintCorrection")
    L_Gripper.addObject('LinearMovementConstraint', template="Rigid3d", keyTimes=[5], movements=[0,1,0,0,1,0])
    # Right Gripper COLLISION MODEL
    L_Gripper_Collision=L_Gripper.addChild('L_Gripper_Collision')
    L_Gripper_Collision.addObject('MeshObjLoader', name="loader", filename="mesh/PSM_Second_Side.obj")
