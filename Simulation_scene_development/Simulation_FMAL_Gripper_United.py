...
def createScene(root):
    ...
    root.addObject('MeshOBJLoader', name="Vein_Surface", filename="mesh/Simulation_meshes/Final_Centered_meshes/Vein_high_res.obj") #seems redundant but is needed otherwise boxroi's do not work
    ...
    Vein_collision.addObject('MeshOBJLoader', name="loader", filename="mesh/Simulation_meshes/Final_Centered_meshes/Vein_mid_res.obj")
    ...
    root.addObject('MeshOBJLoader', name="R_Gripper_Surface", filename="mesh/Simulation_meshes/R_Gripper_Jaw.obj") #seems redundant but is needed otherwise boxroi's do not work###
    ...
    R_Gripper.addObject('MeshGmshLoader', name="meshLoader", filename="mesh/Simulation_meshes/R_Gripper_Jaw.msh")
    #R_Gripper.addObject('TetrahedronSetTopologyContainer', name="topo", src="@meshLoader")
    R_Gripper.addObject('MechanicalObject', name="R_Gripper_Mech", template='Rigid3d', src="@meshLoader", position=[0, 0.005, 0.04, 0, 0, 0, 0], translation=[0, 0, 0], rotation=[0, 0, 0])
    #R_Gripper.addObject('TetrahedronSetGeometryAlgorithms', template="Rigid3d", name="GeomAlgo")
    R_Gripper.addObject('UniformMass', totalMass = "0", showAxisSizeFactor="0.005") ###Don't give mass to the gripper for the moment
    #R_Gripper.addObject('ConstantForceField', force=[0,0,0,0.002,0,0])
    R_Gripper.addObject('GenericConstraintCorrection', name="R_Gripper_ConstraintCorrection")
    ...
    R_Gripper_Collision.addObject('MeshObjLoader', name="loader", filename="mesh/Simulation_meshes/R_Gripper_Jaw.obj")
    ...
    R_Gripper_Visual.addObject('MeshObjLoader', name="loader", filename="mesh/Simulation_meshes/R_Gripper_Jaw.obj")
    ...
    root.addObject('MeshOBJLoader', name="L_Gripper_Surface", filename="mesh/Simulation_meshes/L_Gripper_Jaw.obj") #seems redundant but is needed otherwise boxroi's do not work###
    L_Gripper = Gripper.addChild('L_Gripper')
    # Left Gripper MECHANICAL MODEL
    L_Gripper.addObject('EulerImplicitSolver', name="odesolver",rayleighStiffness=0)
    L_Gripper.addObject('SparseLDLSolver', template="CompressedRowSparseMatrix")
    L_Gripper.addObject('MeshGmshLoader', name="meshLoader", filename="mesh/Simulation_meshes/L_Gripper_Jaw.msh")
    #L_Gripper.addObject('TetrahedronSetTopologyContainer', name="topo", src="@meshLoader")
    L_Gripper.addObject('MechanicalObject', name="L_Gripper_Mech", template='Rigid3d', src="@meshLoader", position=[0, 0.005, 0.04, 0, 0, 0, 0], translation=[0, 0, 0], rotation=[0, 0, 0])
    #L_Gripper.addObject('TetrahedronSetGeometryAlgorithms', template="Rigid3d", name="GeomAlgo")
    L_Gripper.addObject('UniformMass', totalMass = "0", showAxisSizeFactor="0.005") ###Don't give mass to the gripper for the moment
    #L_Gripper.addObject('ConstantForceField', force=[0,0,0,-0.002,0,0])
    L_Gripper.addObject('GenericConstraintCorrection', name="L_Gripper_ConstraintCorrection")
    #L_Gripper.addObject('LinearMovementConstraint', template="Rigid3d", keyTimes=[5], movements=[0,10,0,0,1,0])
    L_Gripper.addObject('LinearMovementConstraint', template="Rigid3d")
    # Left Gripper COLLISION MODEL
    L_Gripper_Collision=L_Gripper.addChild('L_Gripper_Collision')
    L_Gripper_Collision.addObject('MeshObjLoader', name="loader", filename="mesh/Simulation_meshes/L_Gripper_Jaw.obj")
    ...
    L_Gripper_Collision.addObject("RigidMapping", input="@../", output="@Collision_Model")
    # Left Gripper VISUAL MODEL
    L_Gripper_Visual=L_Gripper.addChild('L_Gripper_Visual')
    L_Gripper_Visual.addObject('MeshObjLoader', name="loader", filename="mesh/Simulation_meshes/L_Gripper_Jaw.obj")
    ...
    L_Gripper_Visual.addObject('RigidMapping', name="VisualMapping", input="@../", output="@Visual_Model")
