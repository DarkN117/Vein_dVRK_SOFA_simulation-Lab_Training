...
def createScene(root):
    ...
    root.addObject('MeshOBJLoader', name="R_Gripper_Surface", filename="mesh/R_Gripper_Jaw.obj") #seems redundant but is needed otherwise boxroi's do not work###
    ...
    R_Gripper.addObject('MeshGmshLoader', name="meshLoader", filename="mesh/R_Gripper_Jaw.msh")
    ...
    R_Gripper.addObject('UniformMass', totalMass = "0") ###Don't give mass to the gripper for the moment
    #R_Gripper.addObject('ConstantForceField', force=[0,0,0,0.002,0,0])
    R_Gripper.addObject('MeshOBJLoader', name="R_Gripper_Constraint_Points", filename="mesh/R_Gripper_Jaw.obj")
    R_Gripper.addObject('FixedRotationConstraint',FixedXRotation="0", FixedYRotation="1", FixedZRotation="1")
    ...
    R_Gripper_Collision.addObject('MeshObjLoader', name="loader", filename="mesh/R_Gripper_Jaw.obj")
    ...
    R_Gripper_Visual.addObject('MeshObjLoader', name="loader", filename="mesh/R_Gripper_Jaw.obj")
