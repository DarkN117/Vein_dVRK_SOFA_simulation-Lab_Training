...
def createScene(root):
    ...
    root.addObject('MeshOBJLoader', name="L_Gripper_Surface", filename="mesh/L_Gripper_Jaw.obj") #seems redundant but is needed otherwise boxroi's do not work###
    ...
    L_Gripper.addObject('MeshGmshLoader', name="meshLoader", filename="mesh/L_Gripper_Jaw.msh")
    L_Gripper.addObject('TetrahedronSetTopologyContainer', name="topo", src="@meshLoader")
    L_Gripper.addObject('MechanicalObject', name="L_Gripper_Mech", template='Vec3d', src="@meshLoader")
    L_Gripper.addObject('TetrahedronSetGeometryAlgorithms', template="Vec3d", name="GeomAlgo")
    #L_Gripper.addObject('UniformMass', totalMass = "0") ###Don't give mass to the gripper for the moment
    ...
    L_Gripper_Collision.addObject('MeshObjLoader', name="loader", filename="mesh/L_Gripper_Jaw.obj")
    ...
    L_Gripper_Collision.addObject("BarycentricMapping", input="@../", output="@Collision_Model")
    # Left Gripper VISUAL MODEL
    L_Gripper_Visual=L_Gripper.addChild('L_Gripper_Visual')
    L_Gripper_Visual.addObject('MeshObjLoader', name="loader", filename="mesh/L_Gripper_Jaw.obj")
    ...
    L_Gripper_Visual.addObject('BarycentricMapping', name="VisualMapping", input="@../", output="@Visual_Model")
