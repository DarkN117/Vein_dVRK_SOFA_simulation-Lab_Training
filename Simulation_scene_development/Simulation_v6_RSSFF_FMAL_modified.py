...
class GripperPoseAngleController(Sofa.Core.Controller):
    ...
    def onAnimateEndEvent(self, event): # called at each end of animation step
        ...
        with self.root.Shaft_target_pose.rest_shape.position.writeableArray() as gripperGoalPose:
        		gripperGoalPose[0] = [pose_stamped.pose.position.x, pose_stamped.pose.position.y, pose_stamped.pose.position.z, pose_stamped.pose.orientation.x, pose_stamped.pose.orientation.y, pose_stamped.pose.orientation.z, pose_stamped.pose.orientation.w]
