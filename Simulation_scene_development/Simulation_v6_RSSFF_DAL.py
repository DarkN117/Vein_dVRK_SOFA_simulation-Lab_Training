...
def createScene(root):
    ...
    root.addObject('LocalMinDistance', name="LMD-proximity" , alarmDistance=0.00175, contactDistance=0.0015, useLMDFilters=0)
    ...
    #Vein.addObject('EulerImplicitSolver', name="odesolver")
